				...
				<form action="<?php echo U();?>" method="post" id="reg">
					<ul>
						...
						<li class="checkcode">
							...
							<img id="checkcode" src="<?php echo U('Captcha/show',['nocache'=>NOW_TIME]);?>" title="点击换图" alt="点击换图" onclick='changeCaptcha(this)'/>
						</li>
						<li>
							<label for="">&nbsp;</label>
							<input type="checkbox" class="chb"  name="remember" id="remember"/> 保存登录信息
						</li>
						<li>
							<label for="">&nbsp;</label>
