...
<head>
    ...
    <!--引入jqzoom css -->
    <link rel="stylesheet" href="/Public/css/jqzoom.css" type="text/css">
	...
	<script type="text/javascript">
        ...
        $(function(){
			...
			//页面记载成功,显示访问次数
			var url = '<?php echo U("Goods/getClickTimes");?>';
			var data = {
				id:<?php echo ($row["id"]); ?>,
			};
				...
				<?php if(is_array($goods_categories)): foreach($goods_categories as $key=>$top_cat): if(($top_cat["parent_id"]) == "0"): ?><div class="cat item1">
							...
							<div class="cat_detail">
								<?php if(is_array($goods_categories)): foreach($goods_categories as $key=>$second_cat): if(($second_cat["parent_id"]) == $top_cat["id"]): ?><dl class="dl_1st">
											...
											<dd>
												<?php if(is_array($goods_categories)): foreach($goods_categories as $key=>$third_cat): if(($third_cat["parent_id"]) == $second_cat["id"]): ?><a href=""><?php echo ($third_cat["name"]); ?></a><?php endif; endforeach; endif; ?>
											</dd>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo ($row["logo"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo ($row['galleries'][0]); ?>-m" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php if(is_array($row["galleries"])): foreach($row["galleries"] as $key=>$gallery): ?><li class="<?php if(($key) == "0"): ?>cur<?php endif; ?>">
                                        <a class="<?php if(($key) == "0"): ?>zoomThumbActive<?php endif; ?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($gallery); ?>-m',largeimage: '<?php echo ($gallery); ?>-l'}"><img src="<?php echo ($gallery); ?>-s"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>浏览次数：</span><label id="click_times"></label></li>
					</ul>
					<form action="<?php echo U('Cart/add2car');?>" method="post" class="choose">
						<ul>
			...
			<div class="detail">
				<div class="detail_hd">
					<ul>
						<li class="on first"><span>商品介绍</span></li>
				...
				<div class="detail_bd">
					...
					<div class="comment detail_div mt10 none">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/Public/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/Public/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/Public/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
