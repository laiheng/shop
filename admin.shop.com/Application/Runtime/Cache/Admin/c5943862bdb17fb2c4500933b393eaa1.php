...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <h1>
            <span class="action-span"><a href="<?php echo U('index');?>">文章分类</a></span>
            <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
            <span id="search_id" class="action-span1"> - 添加文章分类 </span>
        </h1>
        ...
        <script type='text/javascript'>
            ...
            //回显是否是帮助
            $('.is_help').val([<?php echo ((isset($row["is_help"]) && ($row["is_help"] !== ""))?($row["is_help"]):1); ?>]);
            });
        </script>
    </body>
</html>